window.ULTIMA7_MARKERS_DATA = {
    ...
    "markers": [
        ...
        },
        {
            "name": "Provisioner",
            "type": "site",
            "description": "Provisioner Britain",
            "position": {
                "x": 26.78,
                "y": 52.68
            }
        ...
        },
        {
            "name": "Shipwright",
            "type": "site",
            "description": "Shipwright Britain",
            "position": {
                "x": 30.87,
                "y": 51.44
            }
        ...
        },
        {
            "name": "Harbor",
            "type": "site",
            "description": "Harbor Buccaneer's Den",
            "position": {
                "x": 55.21,
                "y": 34.98
            }
        ...
        },
        {
            "name": "Trainer",
            "type": "site",
            "description": "Trainer Buccaneer's Den",
            "position": {
                "x": 53.3,
                "y": 36.5
            }
        },
        {
            "name": "Tavern/Inn",
            "type": "site",
            "description": "Tavern/Inn Buccaneer's Den",
            "position": {
                "x": 52.16,
                "y": 40.16
            }
        ...
        },
        {
            "name": "Trainer",
            "type": "site",
            "description": "Trainer Serpent's Hold",
            "position": {
                "x": 46.4839,
                "y": 99.2234
            }
        ...
        {
            "name": "Library of Scars",
            "type": "site",
            "description": "Library of Scars",
            "position": {
                "x": 11.5693,
                "y": 96.0602
            }
        },
        {
            "name": "Provisioner",
            "type": "site",
            "description": "Provisioner Jhelom",
            "position": {
                "x": 9.3883,
                "y": 96.4637
            }
        ...
        {
            "name": "The Bunk and Stool",
            "type": "site",
            "description": "The Bunk and Stool",
            "position": {
                "x": 5.1032,
                "y": 97.0424
            }
        ...
        {
            "name": "Flower Shop and Greenhouse",
            "type": "site",
        ...
        },
        {
            "name": "The Salty Dog",
            "type": "site",
            "description": "The Salty Dog Tavern.",
            "position": {
                "x": 32,
                "y": 40.46
            }
        ...
        },
        {
            "name": "Blacksmith",
            "type": "site",
            "description": "Blacksmith Skara Brae. This building serves no purpose since everyone is undead.",
            "position": {
                "x": 3.3544,
                "y": 72.0184
            }
        ...
        },
        {
            "name": "Town Hall",
            "type": "site",
            "description": "Town Hall Skara Brae.",
            "position": {
                "x": 5.6385,
                "y": 71.842
            }
        ...
        },
        {
            "name": "Blacksmith",
            "type": "site",
            "description": "Blacksmith Trinsic.",
            "position": {
                "x": 31.38,
                "y": 25.05
            }
        },
        {
            "name": "Fellowship Hall",
            "type": "site",
            "description": "Fellowship Hall Trinsic.",
            "position": {
                "x": 33.5,
                "y": 27.74
            }
        ...
        },
        {
            "name": "Provisioner",
            "type": "site",
            "description": "Provisioner Trinsic.",
            "position": {
                "x": 30.97,
                "y": 29.25
            }
        },
        {
            "name": "Shipwright",
            "type": "site",
            "description": "Shipwright Trinsic.",
            "position": {
                "x": 34.53,
                "y": 29.23
            }
        ...
        {
            "name": "Honorable Hound Pub and Inn",
            "type": "site",
            "description": "Honorable Hound Pub and Inn",
            "position": {
                "x": 34.56,
                "y": 26.67
            }
        ...
        {
            "name": "High Court of Britannia",
            "type": "site",
            "description": "High Court of Britannia",
            "position": {
                "x": 9.7751,
                "y": 4.8518
            }
...
window.ULTIMA7_MARKERS = Array.isArray(window.ULTIMA7_MARKERS_DATA?.markers) ? window.ULTIMA7_MARKERS_DATA.markers : [];
window.ULTIMA7_MARKER_BOUNDS = window.ULTIMA7_MARKERS_DATA?.sourceBounds || null;
